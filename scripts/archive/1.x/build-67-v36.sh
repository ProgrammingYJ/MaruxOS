...
# Copy xinitrc with Korean/Japanese encoding support
...
echo ""
echo "Changes in v36:"
echo "  - Windows 11 style taskbar (icon only)"
echo "  - Firefox, Terminal, File Manager launcher icons"
echo "  - Korean/Japanese encoding support"
echo "=========================================="
