#!/bin/bash
# MaruxOS 67-v50 Build Script (Full Korean Support + ibus-hangul with Ctrl+Y)
...
# Apply v50 changes (Full Korean locale support + ibus-hangul)
...
echo "  ✅ 한/영 전환: Ctrl+Y (Firefox 충돌 해결!)"
...
echo "      Fixed: GRUB Korean text → ASCII, Ctrl+Y for input switching"
echo "      v49 issue: Ctrl+P conflicts with Firefox print function → Ctrl+Y"
echo "=========================================="
