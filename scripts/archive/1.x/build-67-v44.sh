#!/bin/bash
# MaruxOS 67-v44 Build Script (Release Config Rollback - Fixed)
...
echo "Release Config Rollback (Correct tint2rc location)"
echo "=========================================="
...
# Apply v44 changes (Release config with correct tint2rc location)
echo "[3/8] Copying config files (release state)..."
...
echo "[5/8] Copying tint2 config to /etc/xdg/tint2/..."
...
echo ""
echo "Changes in v44:"
echo "  - Fixed tint2rc location: /etc/xdg/tint2/ (was /etc/skel/.config/tint2/)"
echo "  - Correct desktop files: marux-menu, firefox, xterm, mc, battery, network, volume"
echo "  - Removed incorrect files: maruxos-menu, terminal, filemanager"
echo "  - Full rollback to release configuration"
echo "=========================================="
