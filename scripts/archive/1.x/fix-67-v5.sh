#!/bin/bash
# 67-v5 - pcmanfm 제거, 데스크톱 아이콘 없이 진행
...
# xinitrc에서 pcmanfm 제거
echo "=== xinitrc 수정 (pcmanfm 제거) ==="
...
xorriso -as mkisofs -o /home/administrator/MaruxOS/output/MaruxOS-1.0-67-v5.iso \
...
echo "=== 완료 ==="
ls -lh /home/administrator/MaruxOS/output/MaruxOS-1.0-67-v5.iso
rm -rf /home/administrator/MaruxOS/iso-modify
