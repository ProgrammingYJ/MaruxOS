#!/bin/bash
# MaruxOS 2.0.0 "Cooked" - cooked-v5 Build Script
# =================================================
# v4 부팅 결과: plank가 여전히 안 뜨고 (이유 미상, 디버그 진행 중) tint2가 systray-only 모드라 화면 "반쪽"으로 보임.
# v5는 임시로 tint2 풀 패널로 복귀 (UX 정상화) + plank 디버그는 병행. plank 잡히면 다시 systray-only로 분기 가능.
#
