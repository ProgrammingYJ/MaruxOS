#!/bin/bash
# MaruxOS 2.0.0 "Cooked" - cooked-v6 Build Script
# =================================================
# v5 부팅 결과: tint2 풀 복귀 ✓ + xterm 한국어 ✓. Plank는 schema 없어 SIGTRAP (v3~v5 공통 회귀).
...
# v5: tint2 항상 풀 패널 (plank 디버그 완료까지 systray-only 모드 일시 보류).
# plank가 정상 작동 확인되면 다시 systray-only 분기 부활 검토.
cp "$CONFIG_DIR/tint2/tint2rc" "$SQUASHFS_ROOT/etc/xdg/tint2/tint2rc"
echo "  ✓ tint2 → full panel mode (v5: plank 디버그 중, systray-only 일시 보류)"
