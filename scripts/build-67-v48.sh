#!/bin/bash
# MaruxOS 67-v48 Build Script (Full Korean Support + ibus-hangul Input Method)
...
# Apply v48 changes (Full Korean locale support + ibus-hangul)
