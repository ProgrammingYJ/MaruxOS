...
| 진행 중 | **2.0.0 "Cooked"** (ARM64 최신 = **arm64-v33** `fc3e038f…` **361M** — 다이어트 + Unlicense/라이선스 동봉 = 출품 제출본 ← v30 `29579682…`: v28에서 Qt 기동 실증(함정 #35 픽스) + 독 아이콘 투명(함정 #36) 픽스 + `.desktop` 내용 게이트. 로드맵 4/4 코드 완주, 실기기 최종 검증 대기 / 8-27 출품) |
