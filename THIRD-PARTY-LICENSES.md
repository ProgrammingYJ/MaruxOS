...
| Wallpaper / app icons designed by **tuna27** (`marux-desktop.png`, `marux-terminal.png`, `marux-file-manager.png`, `marux-logo.png`) | © tuna27 — licensed to MaruxOS for redistribution; **license to be confirmed by the designer** (target: Unlicense or CC BY 4.0). Until confirmed these are *not* part of the public-domain dedication. |
